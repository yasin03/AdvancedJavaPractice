...
public class VeriBankasi {
    ...
    */
    protected List<String> doktorAdi = Arrays.asList("Furkan","Ahmet","Uğur","Yavuz","Ayşe");
    protected List<String> doktorSoyadi = Arrays.asList("Türk","Yıldız","Soyozu","Kartal","Özkiraz");
    ...
    protected List<String> AktuelDurum = Arrays.asList("Alerji","Baş Ağrısı","Diyabet","Migren","Kalp Hastalıkları");
