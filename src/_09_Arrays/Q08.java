    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i = 0; i < arr.length; i++) {
            if (arr[i].contains("$")) {
                sonuc1 += Integer.parseInt(arr[i].replace("$", ""));
            } else {
                sonuc2 += Integer.parseInt(arr[i].replace("£", ""));
            }
        }
        System.out.println("Dolar olanların toplamı : "+sonuc1);
        System.out.println("Sterlin olanların toplamı : "+sonuc2);
